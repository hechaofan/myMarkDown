...
https://github.com/attackonryan/Professional-JavaScript-for-Web-Developers-4th-Edition-reading-notes/blob/master/Chapter3.md
...
https://www.jianshu.com/p/cadcbab793d7

> 我们在判断参数是否为空时，希望把`null`,   `undefined`, `{}`, `[]`,`""` 这五类都判定为空。
...
**关于内置符号，我推荐大家看一看阮一峰老师在[《ECMAScript 6 入门》](https://es6.ruanyifeng.com/#docs/symbol#内置的-Symbol-值)中的讲解**。
...
1. let和var的区别
2. 数据的几种基本类型和如何判断数据的基本数据类型
3. 基本数据的相互转化（隐形转化和显性转化）